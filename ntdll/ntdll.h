...
#if !defined(_NO_NTDLL_ACT_)
#define FLS_MAXIMUM_AVAILABLE 128

#endif	// _NO_NTDLL_ACT_
...
#define LDR_DLL_NOTIFICATION_REASON_UNLOADED 2
	...
	typedef struct _LDR_DATA_TABLE_ENTRY
	{
		...
		ULONG TimeDateStamp;//80
		struct _ACTIVATION_CONTEXT* EntryPointActivationContext;//88
		PVOID Lock; // RtlAcquireSRWLockExclusive //90
		PLDR_DDAG_NODE DdagNode;
		LIST_ENTRY NodeModuleLink;//a0
		struct _LDRP_LOAD_CONTEXT* LoadContext;//a8
		PVOID ParentDllBase;//b0
		PVOID SwitchBackContext;//b8
...
#define PSLIST_ENTRY PSINGLE_LIST_ENTRY
	...
	NTSTATUS NTAPI LdrGetDllFullName(HMODULE module, UNICODE_STRING* name);
